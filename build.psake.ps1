...
# $ModuleRootDir under the $OutDir.  Later, other tasks such as Sign and BuildHelp
...
Task CoreStageFiles -requiredVariables ModuleOutDir, ModuleRootDir {
    ...
    Copy-Item -Path $ModuleRootDir\* -Destination $ModuleOutDir -Recurse -Exclude $Exclude -Verbose:$VerbosePreference
}
...
Task Test -requiredVariables TestRootDir, ModuleName, CodeCoverageEnabled, CodeCoverageFiles {
